...
void TMVAGlob::CreateCanvasandFrameROC(TFile *inputFile, const double & minPTbin, const double & maxPTbin, const double & puMin, const double & puMax, const std::string & outputPlotDirectory){
...
void TMVAGlob::plotEfficiency (std::vector<TFile*> inputFile, TDirectory* dir, const double & minPTbin, const double & maxPTbin, const double & puMin, const double & puMax, const std::string & outputPlotDirectory){
