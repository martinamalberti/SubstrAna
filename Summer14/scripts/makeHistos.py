...
def writeJobs(wdir, indir, outputname, ptmin, ptmax, etamin, etamax):
    #---------------------------------------------
...
if not options.checkJobs and not options.resubmit:
    ...
    writeJobs(workingdir, options.inputdir, options.outputname, options.ptmin, options.ptmax, options.etamin, options.etamax )
