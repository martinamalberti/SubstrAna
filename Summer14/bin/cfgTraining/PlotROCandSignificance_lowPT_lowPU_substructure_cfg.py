...
process.Options = cms.PSet(
   ...
   InputInformationParam =  cms.VPSet(
    ...
    cms.PSet( fileName = cms.string("SingleVariablesTraining_lowPT_lowPU/outputTMVATraining_lowPT_lowPU/TMVATrainingResult_QGLikelihood_sub2_PTBin_300_450_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("QG Likelihood sub2"), JetPtBinOfTraining = cms.vdouble(300,450), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("QGLikelihood_sub2")),
    ...
    cms.PSet( fileName = cms.string("SingleVariablesTraining_lowPT_lowPU/outputTMVATraining_lowPT_lowPU/TMVATrainingResult_pullangle_PTBin_300_450_PU_0_39.root"),  inputVariableOrMethodName = cms.vstring("Pull Angle"), JetPtBinOfTraining = cms.vdouble(300,450), PileUpBinOfTraining = cms.vdouble(0,39), ReducedName = cms.string("pullangle")),
