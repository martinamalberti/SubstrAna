...
process.Options = cms.PSet(
   ...
   InputInformationParam =  cms.VPSet(
    cms.PSet( fileName = cms.string("PairVariablesTraining_highPT_highPU_BDTG/outputTMVATraining_highPT_highPU/TMVATrainingResult_mpruned_QGLikelihood_comb_PTBin_475_600_PU_39_100.root"),  inputVariableOrMethodName = cms.vstring("BDT: M_{pruned}+Q/G combo"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(39,100), ReducedName = cms.string("BDT_1")),
    ...
    cms.PSet( fileName = cms.string("PairVariablesTraining_highPT_highPU_BDTG/outputTMVATraining_highPT_highPU/TMVATrainingResult_mpruned_ECFbeta15_PTBin_475_600_PU_39_100.root"),  inputVariableOrMethodName = cms.vstring("BDT: M_{pruned}+C_{2}(#beta=1.5)"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(39,100), ReducedName = cms.string("BDT_3")),
    cms.PSet( fileName = cms.string("TripletVariablesTraining_highPT_highPU_BDTG/outputTMVATraining_highPT_highPU/TMVATrainingResult_msoftbeta10_mpruned_tau2tau1_PTBin_475_600_PU_39_100.root"),  inputVariableOrMethodName = cms.vstring("BDT: M_{soft}(#beta=1)+M_{pruned}+#tau_{2}/#tau_{1}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(39,100), ReducedName = cms.string("BDT_4")),
    cms.PSet( fileName = cms.string("TripletVariablesTraining_highPT_highPU_BDTG/outputTMVATraining_highPT_highPU/TMVATrainingResult_msoftbeta10_tau2tau1_QGLikelihood_comb_PTBin_475_600_PU_39_100.root"),  inputVariableOrMethodName = cms.vstring("BDT: M_{soft}(#beta=1)+Q/G combo+#tau_{2}/#tau_{1}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(39,100), ReducedName = cms.string("BDT_5")),
