...
int main (int argc, char ** argv) {
  ...
  int maxEvents              = Options.getParameter<int>("maxEvents");
  double jetR                = Options.getParameter<double>("jetR");
  bool doCMSSWJets           = Options.getParameter<bool>("doCMSSWJets");
  std::string puppiConfig    = Options.getParameter<std::string>("puppiConfig");
