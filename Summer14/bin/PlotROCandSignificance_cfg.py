...
#     cms.PSet( fileName = cms.string("output/outputTMVATraining_CHS_BDTG/TMVATrainingResult_msoftbeta10_tau2_PTBin_475_600_PU_0_100.root"),  inputVariableOrMethodName = cms.vstring("M_{soft}+#tau_{2}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,100),ReducedName = cms.string("msoft_tau2")),
#     cms.PSet( fileName = cms.string("output/outputTMVATraining_CHS_BDTG/TMVATrainingResult_msoftbeta10_tau1_PTBin_475_600_PU_0_100.root"),  inputVariableOrMethodName = cms.vstring("M_{soft}+#tau_{1}"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,100),ReducedName = cms.string("msoft_tau1")),
...
#     cms.PSet( fileName = cms.string("output/outputTMVATraining_CHS_BDTG/TMVATrainingResult_allvar_correlation_PTBin_475_600_PU_0_100.root"),  inputVariableOrMethodName = cms.vstring("All Variables"), JetPtBinOfTraining = cms.vdouble(475,600), PileUpBinOfTraining = cms.vdouble(0,100),ReducedName = cms.string("allvariables")),
