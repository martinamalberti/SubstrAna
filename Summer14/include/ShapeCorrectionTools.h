...
//#include "../../../fastjet/1.012-alpha-PUWS14.1/GenericSubtractor/ExampleShapes.hh"
...
//void do_GenericShapeSubtract_correction(fastjet::PseudoJet jet_origin, Double_t jetradius, fastjet::BackgroundEstimatorBase* bge_rho, float& jetpt_new, float& jetmass_new, float& tau2tau1_shapesubtraction, Double_t& rhom);
...
void InitAll();//init all the branch value
void     setnPU( Double_t in_nPU );
...
Double_t getnPU( );//const edm::Event& iEvent );        
